...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <?php
            $user = get_user_by_id($user_profile_id);
            $user_image = get_user_image($user['id']);
            $user_social_networks = get_user_social_networks($user['id']);
                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    <img src="<?php echo $user_image['image']; ?>" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <h5 class="mb-0 fw-700 text-center mt-3">
                                        <?php echo $user_info['name']; ?>
                                        <small class="text-muted mb-0"><?php echo $user_info['profession']; ?></small>
                                    </h5>
                                    <div class="mt-4 text-center demo">
                                        <a href="<?php echo $user_social_networks['inst']; ?>" class="fs-xl" style="color:#C13584">
                                            <i class="fab fa-instagram"></i>
                                        </a>
                                        <a href="<?php echo $user_social_networks['vk']; ?>" class="fs-xl" style="color:#4680C2">
                                            <i class="fab fa-vk"></i>
                                        </a>
                                        <a href="<?php echo $user_social_networks['tg']; ?>" class="fs-xl" style="color:#0088cc">
