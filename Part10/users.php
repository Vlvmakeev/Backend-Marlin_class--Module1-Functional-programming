                                    ...
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <div class="  dropdown-menu">
                                                <a class="dropdown-item" href="edit.php?id=<?php echo $card['id']; ?>">
                                                    <i class="fa fa-edit"></i>
                                                Редактировать</a>
                                                <a class="dropdown-item" href="security.php?id=<?php echo $card['id']; ?>">
                                                    <i class="fa fa-lock"></i>
                                                Безопасность</a>
                                                <a class="dropdown-item" href="status.php?id=<?php echo $card['id']; ?>">
                                                    <i class="fa fa-sun"></i>
                                                Установить статус</a>
                                                <a class="dropdown-item" href="media.php?id=<?php echo $card['id']; ?>">
                                                    <i class="fa fa-camera"></i>
                                                    Загрузить аватар
                                                </a>
                                                <a href="delete.php?id=<?php echo $card['id']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
